...
const TrendingCard: FC<TrendingCardProps> = ({
  ...
  return (
    <Link href={"/product/1"}>
      <div className="group flex flex-col gap-y-4 border-2 border-white hover:cursor-pointer hover:border-main_orange rounded-2xl p-4 transition-all duration-500 shadow-xl hover:shadow-lg">
        ...
        <div className="w-full flex items-center justify-between">
          <div className="w-fit flex items-center justify-between pl-1 pr-4 py-1 rounded-xl bg-main_orange">
          ...
          <div className="flex items-center justify-between gap-x-1">
            <span className="font-[family-name:var(--font-inter)] font-normal text-lg text-[#7780A1]/20 group-hover:text-main_orange group-hover:drop-shadow-2xl transition-all duration-500">
              {`See more ->`}
            </span>
          </div>
        </div>
